...
//FIXME
var parser = this._unit.getParser(this._params.dateTimeFormat);
this._start=parser(this._params.centersOn);
...
var H=new Timeline.LinearEther({centersOn:("date" in F)?F.date:new Date(),dateTimeFormat:("dateTimeFormat" in F)?F.dateTimeFormat:"",interval:SimileAjax.DateTime.gregorianUnitLengths[F.intervalUnit],pixelsPerInterval:F.intervalPixels,theme:G});
//FIXME
